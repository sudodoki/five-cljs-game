...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7422__auto__,writer__7423__auto__,opt__7424__auto__){
return cljs.core._write(writer__7423__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13833 = o;
(G__13833[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__6799__auto__ = !((jsprops == null));
if(and__6799__auto__){
var and__6799__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__13842 = jsprops;
(G__13842["defaultValue"] = value);

(G__13842["onChange"] = ((function (G__13842,v,value,on_change){
return (function (p1__13839_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13839_SHARP_);
});})(G__13842,v,value,on_change))
);

(G__13842["ref"] = ((function (G__13842,v,value,on_change){
return (function (p1__13840_SHARP_){
return (this$["cljsInputElement"] = p1__13840_SHARP_);
});})(G__13842,v,value,on_change))
);
...
var vec__13849 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13849,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13849,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13849,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13854 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13854 == null)){
} else {
var key_13855 = temp__4661__auto___13854;
(jsprops["key"] = key_13855);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13857 = (new reagent.impl.template.NativeWrapper());
(G__13857["name"] = c);
...
var G__13859 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13859) : reagent.impl.template.as_element.call(null,G__13859));
} else {
...
var len__7924__auto___13865 = arguments.length;
var i__7925__auto___13866 = (0);
while(true){
if((i__7925__auto___13866 < len__7924__auto___13865)){
args__7931__auto__.push((arguments[i__7925__auto___13866]));

var G__13867 = (i__7925__auto___13866 + (1));
i__7925__auto___13866 = G__13867;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7932__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13863){
var G__13864 = cljs.core.first(seq13863);
var seq13863__$1 = cljs.core.next(seq13863);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13864,seq13863__$1);
});
...
break;
default:
var G__13871 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13871;
continue;
...
var n__7734__auto___13874 = a.length;
var i_13875 = (0);
while(true){
if((i_13875 < n__7734__auto___13874)){
(a[i_13875] = reagent.impl.template.as_element((a[i_13875])));

var G__13876 = (i_13875 + (1));
i_13875 = G__13876;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7734__auto___13877 = a.length;
var i_13878 = (0);
while(true){
if((i_13878 < n__7734__auto___13877)){
var val_13879 = (a[i_13878]);
if((cljs.core.vector_QMARK_(val_13879)) && ((reagent.impl.template.key_from_vec(val_13879) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13878] = reagent.impl.template.as_element(val_13879));
...
var ctx = ({});
var vec__13884 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13884,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13884,(1),null);
...
var G__13888 = (cljs.core.count(argv) - first_child);
switch (G__13888) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13888){
